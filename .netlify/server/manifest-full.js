	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/labels/_server.js'))
			},
			{
				id: "/api/labels/[id]",
				pattern: /^\/api\/labels\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/labels/_id_/_server.js'))
			},
			{
				id: "/api/members/[id]",
				pattern: /^\/api\/members\/([^/]+?)\/?$/,
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/members/_id_/_server.js'))
			},
			{
				id: "/api/projects",
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/projects/_id_/_server.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/projects/_id_/members/_server.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/projects/_id_/stats/_server.js'))
			},
			{
				id: "/api/tasks",
				pattern: /^\/api\/tasks\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/tasks/_server.js'))
			},
			{
				id: "/api/tasks/kanban",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/tasks/kanban/_server.js'))
			},
			{
				id: "/api/tasks/[id]",
				pattern: /^\/api\/tasks\/([^/]+?)\/?$/,
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/tasks/_id_/_server.js'))
			},
			{
				id: "/api/users",
				pattern: /^\/api\/users\/?$/,
